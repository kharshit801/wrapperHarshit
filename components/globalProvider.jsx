    ...
    switch (action.type) {
        ...
        case 'LOAD_EXPENSES':
            return {
                ...
                summary: calculateSummaryWithCurrency(action.payload, state.defaultCurrency, state.exchangeRates)
            };
...
const calculateSummaryWithCurrency = (transactions, targetCurrency, exchangeRates) => {
        ...
        try {
            ...
            Object.keys(data.rates).forEach(toCurrency => {
                Object.keys(data.rates).forEach(fromCurrency => {
                    ...
                    formattedRates[key] = data.rates[toCurrency] / data.rates[fromCurrency];
                });
            });
